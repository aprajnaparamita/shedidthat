...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get splashBubbleText => '你的暧昧对象刚做了一件让你抓狂的事，你需要立刻吐槽。Jess随时待命。一个AI闺蜜，永远在线，永远投入，真心实意地在电话旁等着你。好问题。零评判。官方评级。她第一声就接了。开始聊吧。';

  @override
  String get privacyTitle => '🔒 你的隐私很重要';

  @override
  String get privacyText => '所有对话只存储在你的设备本地。没有账户。没有云存储。没有数据收集。当你删除应用程序时，一切都会随之消失。';
  ...
  @override
  String get nagBody => '这个应用是免费、开源的，由一个人深夜打造，因为萨福会希望这样。\n\n如果它让你笑了，考虑给我买杯咖啡吧。每一份支持都很有帮助。';
